...
public class MainPage extends AbsBasePage {
  private String path = System.getProperty("base.url", "https://otus.ru");
  ...
  public MainPage clickCourseUsingMouse() {
    new Actions(driver).click(courseTitleHomePage);
    return this;
  }

  public void checkCourseTitleIsDisplayed() {
